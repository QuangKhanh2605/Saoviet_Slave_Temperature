...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, NET485IO_Pin|LED_BL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ON_SEN_GPIO_Port, ON_SEN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : LED_TX485_Pin */
  GPIO_InitStruct.Pin = LED_TX485_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LED_TX485_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : LED_RX485_Pin */
  GPIO_InitStruct.Pin = LED_RX485_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LED_RX485_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : SW_SET_Pin */
  GPIO_InitStruct.Pin = SW_SET_Pin;
  ...
  /*Configure GPIO pin : ON_SEN_Pin */
  GPIO_InitStruct.Pin = ON_SEN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(SW_ON_BL_GPIO_Port, &GPIO_InitStruct);
