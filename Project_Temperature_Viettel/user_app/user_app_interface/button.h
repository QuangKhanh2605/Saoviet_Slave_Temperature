...
#define BUT_COUNT_FAST          60

#define BUTTON_UP           HAL_GPIO_ReadPin(SW_EXIT_GPIO_Port, SW_EXIT_Pin)
#define BUTTON_DOWN         HAL_GPIO_ReadPin(SW_UP_GPIO_Port, SW_UP_Pin)
#define BUTTON_ESC          HAL_GPIO_ReadPin(SW_DOWN_GPIO_Port, SW_DOWN_Pin)
#define BUTTON_ENTER        HAL_GPIO_ReadPin(SW_ON_BL_GPIO_Port, SW_ON_BL_Pin)
